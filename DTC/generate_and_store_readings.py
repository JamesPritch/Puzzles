...
sensor_output = np.array([[9*60*60+0, 22.5, 45.2, 1013.2, 12],
                          [9*60*60+1, 22.6, 45.1, 1013.1, 14],
                          [9*60*60+2, 22.7, 45.3, 1013.0, 13],
                          [9*60*60+3, 22.8, 45.5, 1012.9, 16],
                          [9*60*60+4, 22.6, 45.4, 1012.8, 15]])
